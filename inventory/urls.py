...
from .views import (
    ...
    EquipmentUpdateView,
    InventoryWorkbookExportView,
    InventoryWorkbookView,
...
urlpatterns = [
    ...
    path("workbook/", InventoryWorkbookView.as_view(), name="workbook"),
    path("workbook/export/", InventoryWorkbookExportView.as_view(), name="workbook-export"),
